...
CREATE TABLE t_idmap (
  ...
  name              VARCHAR(60)  COMMENT '企业名',
  link              VARCHAR(500)  COMMENT '查询链接',
...
CREATE TABLE t_scompany (
  ...
  company_name      VARCHAR(60) COMMENT '企业名称',
  ...
  business          VARCHAR(2000) COMMENT '经营范围',
  stockholder       VARCHAR(100) COMMENT '股东/发起人',
  detail            VARCHAR(2000) COMMENT '具体经营项目',
